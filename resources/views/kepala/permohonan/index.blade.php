            ...
            <div class="card shadow-sm border-0 h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col">
                            <div class="text-xs fw-bold text-warning text-uppercase mb-1">Sedang Diproses (Staf)</div>
                            <div class="h5 mb-0 fw-bold text-gray-800">{{ $jumlahDiproses }}</div>
                        </div>
            ...
            <a href="{{ route('kepala.permohonan.index') }}">
                <div class="card shadow-sm border-left-primary h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col">
                                <div class="text-xs fw-bold text-primary text-uppercase mb-1">Menunggu Tindakan Anda (Eskalasi)</div>
            ...
            <table class="table table-borderless table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr class="data-row">
                        ...
                        <td>
                            <span class="fst-italic text-muted" title="{{ $permohonan->alasan_eskalasi }}">
                                "{{ Str::limit($permohonan->alasan_eskalasi, 40) }}"
                            </span>
                        </td>
...
<style>
    .border-left-primary {
        border-left: .25rem solid #6759ff !important;
    }
