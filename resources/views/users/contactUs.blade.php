...
{{-- Bagian 2: Google Maps --}}
<div class="container-fluid p-0">
    {{-- 
      Catatan: Anda bisa mengganti `src` di bawah ini dengan link embed dari lokasi Google Maps yang Anda inginkan.
      Ini adalah contoh untuk Kantor Walikota Blitar.
    --}}
    <iframe 
...
<style>
    ...
    .contact-icon {
        ...
        font-size: 1.75rem;
        color: #0d6efd; /* Warna biru utama Bootstrap */
    }
</style>
@endpush